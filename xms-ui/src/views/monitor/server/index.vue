            ...
            <table cellspacing="0" style="width: 100%;">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="el-table__cell is-leaf"><div v-if="server.mem" :class="{'text-danger': server.mem.usage > 80}" class="cell">{{ server.mem.usage }}%</div></td>
                  <td class="el-table__cell is-leaf"><div v-if="server.jvm" :class="{'text-danger': server.jvm.usage > 80}" class="cell">{{ server.jvm.usage }}%</div></td>
                </tr>
              </tbody>
            </table>
          </div>
            ...
            <table cellspacing="0" style="width: 100%;table-layout:fixed;">
              <tbody>
                ...
                <tr>
                  ...
                  <td class="el-table__cell is-leaf" colspan="3"><div v-if="server.jvm" class="cell">{{ server.jvm.home }}</div></td>
                </tr>
                <tr>
                  <td class="el-table__cell is-leaf" colspan="1"><div class="cell">项目路径</div></td>
                  <td class="el-table__cell is-leaf" colspan="3"><div v-if="server.sys" class="cell">{{ server.sys.userDir }}</div></td>
                </tr>
                <tr>
                  <td class="el-table__cell is-leaf" colspan="1"><div class="cell">运行参数</div></td>
                  <td class="el-table__cell is-leaf" colspan="3"><div v-if="server.jvm" class="cell">{{ server.jvm.inputArgs }}</div></td>
                </tr>
              </tbody>
            </table>
          </div>
            ...
            <table cellspacing="0" style="width: 100%;">
              ...
              <tbody v-if="server.sysFiles">
                <tr v-for="(sysFile, index) in server.sysFiles" :key="index">
                  ...
                  <td class="el-table__cell is-leaf"><div :class="{'text-danger': sysFile.usage > 80}" class="cell">{{ sysFile.usage }}%</div></td>
                </tr>
              </tbody>
            </table>
          </div>
