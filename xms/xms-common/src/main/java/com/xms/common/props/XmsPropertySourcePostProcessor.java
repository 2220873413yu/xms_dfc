 ...
 */
@Slf4j
public class XmsPropertySourcePostProcessor implements BeanFactoryPostProcessor, InitializingBean, Ordered {
	private final ResourceLoader resourceLoader;
	private final List<PropertySourceLoader> propertySourceLoaders;

	public XmsPropertySourcePostProcessor() {
	...
	public void postProcessBeanFactory(ConfigurableListableBeanFactory beanFactory) throws BeansException {
		...
		Map<String, Object> beansWithAnnotation = beanFactory.getBeansWithAnnotation(XmsPropertySource.class);
		...
		for (Map.Entry<String, Object> entry : beanEntrySet) {
			...
			XmsPropertySource propertySource = AnnotationUtils.getAnnotation(beanClass, XmsPropertySource.class);
