...
import com.xms.common.filter.PropertyPreExcludeFilter;
...
{
    /** 排除敏感属性字段 */
    public static final String[] EXCLUDE_PROPERTIES = { "password", "oldPassword", "newPassword", "confirmPassword","payPwd","loginPwd" };
