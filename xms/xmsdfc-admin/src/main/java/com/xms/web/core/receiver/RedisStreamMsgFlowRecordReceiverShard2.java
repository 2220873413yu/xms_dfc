...
public class RedisStreamMsgFlowRecordReceiverShard2 {
	...
	public void msgFlowRecordReceiver(MapRecord<String, String, byte[]> mapRecord) {
		...
		recordValue.forEach((key, messageBody) -> {
			...
			log.info("=========>>>Shard-2   key 反序列化：{}   || MapRecord 的 userMoneyCanalWrapper, {}", key, userMoneyCanalWrapper.getAfter().getId());
